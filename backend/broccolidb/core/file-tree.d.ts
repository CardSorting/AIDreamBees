...
export declare class FileTree {
     ...
     */
    writeFile(branch: string, path: string, content: string, author: string, options?: {
        encoding?: 'utf-8' | 'base64';
        message?: string;
     ...
     */
    deleteFile(branch: string, path: string, author: string, options?: {
        message?: string;
    }): Promise<string>;
    /**
     ...
     */
    listFiles(branch: string, prefix?: string): Promise<{
        path: string;
        size: number;
    }[]>;
    /**
     ...
     */
    moveFile(branch: string, fromPath: string, toPath: string, author: string, options?: {
        message?: string;
    }): Promise<string>;
    /**
     * Copy a file atomically using CAS pointers (zero storage overhead).
     */
    copyFile(branch: string, fromPath: string, toPath: string, author: string, options?: {
        message?: string;
    }): Promise<string>;
    /**
     ...
     */
    listDirectory(branch: string, path?: string): Promise<{
        name: string;

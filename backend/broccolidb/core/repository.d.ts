...
export declare class Repository {
    ...
    createBranch(name: string, fromBranchOrNode?: string, options?: {
        isEphemeral?: boolean;
    }): Promise<void>;
    ...
    commit(branchName: string, data: any, author: string, message?: string, options?: {
        type?: 'snapshot' | 'summary' | 'diff';
        usage?: Usage;
     ...
     */
    commitInTransaction(transaction: admin.firestore.Transaction, branchName: string, nodeId: string, data: any, author: string, message?: string, options?: {
        type?: 'snapshot' | 'summary' | 'diff';
        usage?: Usage;
        metadata?: Record<string, any>;
        decisionIds?: string[];
     ...
     */
    simulateMerge(sourceRef: string, targetRef: string): Promise<ConflictResult & {
        lcaId: string | null;
     ...
     */
    mergeTrees(transaction: admin.firestore.Transaction, baseHash: string | null, sourceHash: string | null, targetHash: string | null): Promise<{
        hash: string;
        conflicts: string[];
    }>;
    ...
    reset(branch: string, targetRef: string, author: string, options?: {
        mode?: 'hard' | 'soft';
        usage?: Usage;
        metadata?: Record<string, any>;
    }): Promise<void>;
    ...
    getRefLog(branch: string, options?: {
        limit?: number;
    }): Promise<RefLogEntry[]>;
     ...
     */
    getContextGraph(branch: string, filePath: string, limit?: number): Promise<{
        path: string;
        weight: number;
    }[]>;
    /**
     ...
     */
    detectChokepoints(branch: string, limit?: number): Promise<{
        path: string;
        score: number;
        churn: number;
        authors: number;
     ...
     */
    calculateBlastRadius(branch: string, filePath: string, maxDepth?: number): Promise<{
        path: string;
        depth: number;
    }[]>;
}

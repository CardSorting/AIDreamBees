...
export declare class AgentContext {
    ...
    private get kbCol();
    addKnowledge(kbId: string, type: 'fact' | 'vector' | 'rule', content: string, options?: {
        tags?: string[];
        edges?: GraphEdge[];
        embedding?: number[];
        confidence?: number;
     ...
     */
    updateKnowledge(kbId: string, patch: {
        content?: string;
        tags?: string[];
        edges?: GraphEdge[];
        embedding?: number[];
     ...
     */
    decayConfidence(factor: number, olderThan: Date): Promise<{
        decayedCount: number;
    }>;
    /**
     ...
     */
    searchKnowledge(query: string, tags?: string[], limit?: number, queryEmbedding?: number[], options?: {
    ...
    spawnTask(taskId: string, agentId: string, description: string, complexity?: number, linkedKnowledgeIds?: string[]): Promise<void>;

...
export declare class EnvironmentTracker {
     ...
     */
    static setPricing(modelId: string, rates: {
        input: number;
        output: number;
    }): void;
    /**
     ...
     */
    static recordUsage(db: admin.firestore.Firestore, basePath: string, agentId: string, usage: {
        promptTokens: number;
        completionTokens: number;
        modelId?: string;
     ...
     */
    static getStats(db: admin.firestore.Firestore, basePath: string, agentId?: string, taskId?: string): Promise<{
        totalCommits: number;
        totalTokens: number;
        totalCost: number;
    }>;
